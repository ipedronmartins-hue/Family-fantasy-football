    ...
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col pb-20">
      ...
      <main className="flex-1 px-5 pt-6">
        ...
        <div className="mb-8 rounded-2xl border border-line bg-white p-4">
          ...
          <Link href="/gondomar/fundo" className="mt-3 block text-center text-sm font-semibold text-blue">
            Ver Fundo da Equipa →
          </Link>
        </div>
        ...
        <div className="mb-4 grid grid-cols-3 gap-2 text-center text-xs font-semibold text-blue">
          <Link href="/gondomar/plantel" className="rounded-xl border border-line bg-white py-3">
            Plantel
          </Link>
          <Link href="/gondomar/fundo" className="rounded-xl border border-line bg-white py-3">
            Fundo
          </Link>
          {hasTeam && parent.isAdmin && (
            <Link href="/gondomar/admin" className="rounded-xl border border-gold bg-gold/10 py-3 text-ink">
              Admin
            </Link>
          )}
        </div>
