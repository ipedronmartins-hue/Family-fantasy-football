...
export default async function EquipaPage({ params }: { params: Promise<{ teamSlug: string }> }) {
  ...
  const [roster, supabase] = await Promise.all([getRoster(team.seasonId), createServerSupabase()]);
