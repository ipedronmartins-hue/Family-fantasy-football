...
begin
  ...
  -- Slug combines club + escalão (e.g. "gondomar-sub-13") -- using the
  -- escalão alone would collide constantly, since age categories like
  -- "Sub-13" repeat across every club.
