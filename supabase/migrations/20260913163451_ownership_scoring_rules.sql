...
set rules = rules || '{
  "ownership": {
    "goalsByPosition": {"GR": 10, "DEF": 6, "MED": 5, "EXT": 5, "AV": 4},
    "assist": 3,
    "cleanSheetGoalkeeperDefender": 4,
...
-- Also seed this for any future team approved via approve_team_registration.
...
begin
  ...
  v_slug := lower(v_request.team_name);
